...
- прочитать и написать конспект по тому, [как продуктивно задавать вопросы](https://www.opennet.ru/docs/RUS/smart_question/)
...
- Написан конспект к [статье](https://www.opennet.ru/docs/RUS/smart_question/), с пунктами, описывающими что нужно сделать при возникновении вопросов (от 10 пунктов) - +1 балл
