...
- поле поиска позволяет ввести имя гороода и увидеть информацию о погоде в нем
- блок отображения погоды показывает температуру и погодные условия в выбранном горооде
- блок отображения карты для текущего города (с использованием Static Maps, интерактивность не требуется)
- блок отображения истории поиска (последние 10 городов, которые смотрел пользователь, без повторов)

Для базовой разметки (если не хочется писать html и css) можно использовать [заготовку](https://github.com/vvscode/weather-app)
