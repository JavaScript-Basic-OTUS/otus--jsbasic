...
- реализовать рефакторинг приложения вынеся логку работы с апи, получение местоположения пользователя и работу с хранилищем в сервисный слой
- заиспользовать созданные сервисы в приложении
